...
import org.springframework.web.client.RestTemplate;import com.fasterxml.jackson.databind.JsonNode;
...
public class AuthService {
    ...
    public Long getOwnerIdByUsername(String username) {
        ...
        String url = apiBaseUrl + "/api/owner/username/" + username;
        HttpHeaders headers = new HttpHeaders();
        HttpEntity<String> entity = new HttpEntity<>(headers);
    ...
    public void resetPassword(Long ownerId, String newPassword) {
        String url = apiBaseUrl + "/api/owner/changePassword/" + ownerId;
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
        ...
        try {
            // Cambiar String.class a Owner.class para coincidir con la respuesta de la API
            ...
            // Opcional: Puedes usar response.getBody() si necesitas el Owner devuelto
        } catch (HttpClientErrorException e) {
